...
},{"to-px":11}],7:[function(require,module,exports){
...
},{"parse-unit":7}],12:[function(require,module,exports){
//
...
require('resl')({
  ...
  onDone: ({
    ...
    const cube1 = regl.cube(posx, negx, posy, negy, posz, negz);
    const cube2 = regl.cube(posx2, negx2, posy2, negy2, posz2, negz2);
    regl.frame(() => {
      camera(state => {
        // Performance boost 
...
},{"regl":9,"regl-camera":8,"resl":10}]},{},[12]);
