...
},{"to-px":10}],7:[function(require,module,exports){
...
},{"gl-mat4/identity":1,"gl-mat4/lookAt":2,"gl-mat4/perspective":3,"mouse-change":4,"mouse-wheel":6}],9:[function(require,module,exports){
...
},{"parse-unit":7}],11:[function(require,module,exports){
...
const PARAMS = {
  respawn: 5,
  // smaller is faster respawns
  n: 1e4,
  groups: 60,
  // smaller is bigger chucks
  speed: 2,
  beta: 0,
  k: 0,
  mu: 1,
...
var pointBuffer = Array(PARAMS.n).fill().map(function () {
  return [
  // pos
  Math.random() * 2 * PARAMS.amplitude - PARAMS.amplitude, Math.random() * 2 * PARAMS.amplitude - PARAMS.amplitude, Math.random() * 2 * PARAMS.amplitude - PARAMS.amplitude];
});
...
regl.frame(({
  ...
  pointBuffer = pointBuffer.map((el, i) => {
    if (updateGroupIndex == i % PARAMS.groups) return [Math.random() * 2 * PARAMS.amplitude - PARAMS.amplitude, Math.random() * 2 * PARAMS.amplitude - PARAMS.amplitude, Math.random() * 2 * PARAMS.amplitude - PARAMS.amplitude];
...
},{"./utils":14,"regl":9,"regl-camera":8,"tweakpane":12,"tweakpane-latex":11}],14:[function(require,module,exports){
const {
  PARAMS
} = require("./index.js");
function f_x(x, y, z) {
