...
pane.addBlade({
  view: "latex",
  content: `
# Flamm's Paraboloid (Black Hole Geometry)

Flamm's paraboloid is a spatial curvature of the Schwarzschild solution for when $r > r_s$, where $r_s$ is defined as the radius of the event horizon.
